...
VALUES
    ("Francisco", "Salinas", "299-684-0349", "Osa Mayor 123"),
    ("Caterine", "Stephens", "294-684-2799", "Pasaje de la Paz 281"),
    ("Gaston", "Diaz", "297-655-8274", "Los Alerces 1215");
...
INSERT INTO
    historial_clinico (id_mascota, id_veterinario, fecha_registro, descripcion)
VALUES
    (1, 1, "2024-11-26 10:30:00", "Paciente produce bolas de pelos descomunalmente grandes"),
    (2, 1, DEFAULT, "Paciente para castracion"),
    (3, 2, "2023-03-02 15:45:00", "Paciente presenta sarpullido en el lomo");
